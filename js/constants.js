  ...
  wildMagicTable: [
    {
      ...
      level: 1,
      used: false,
      description: "A reactive ward that spikes your defenses for a round when danger closes in.",
    },
    {
      id: crypto.randomUUID(),
      name: "Magic Missile",
      ...
      used: false,
      description:
        "Three darts of force strike without needing an attack roll, useful when accuracy matters more than damage ceiling.",
    },
    {
      id: crypto.randomUUID(),
      name: "Chromatic Orb",
      ...
      used: false,
      description:
        "A flexible elemental blast that lets you choose the damage type to exploit resistances or vulnerabilities.",
    },
    {
      id: crypto.randomUUID(),
      name: "Mirror Image",
      ...
      used: false,
      description:
        "Illusory duplicates blur your outline and waste enemy attacks before they reach the real you.",
    },
    {
      id: crypto.randomUUID(),
      name: "Misty Step",
      ...
      used: false,
      description:
        "A short-range teleport that gets you out of grapples, flanks, and dangerous terrain without provoking.",
    },
    {
      id: crypto.randomUUID(),
      name: "Shatter",
      ...
      used: false,
      description:
        "A violent burst of thunder punishes clustered foes and tears through brittle objects in the area.",
    },
    {
      id: crypto.randomUUID(),
      name: "Counterspell",
      ...
      used: false,
      description:
        "Interrupt another caster at the crucial moment and shut down a dangerous spell before it resolves.",
    },
    {
      id: crypto.randomUUID(),
      name: "Fireball",
      ...
      used: false,
      description:
        "The classic burst of explosive flame. High area damage when the fight needs to end immediately.",
    },
    {
      id: crypto.randomUUID(),
      ...
      used: false,
      description:
        "A shifting lattice of color that can lock down a whole encounter when enemies fail their saves.",
    },
    {
      id: crypto.randomUUID(),
      name: "Polymorph",
      ...
      used: false,
      description:
        "Turn an ally into a hardy beast or an enemy into something far less dangerous, depending on the moment.",
    },
  ],
